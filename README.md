...
A curated collection of useful apps and websites for Muslim users. Contributions are welcome — please submit a pull request or open an issue to suggest additions or improvements.
...
- [Zakatcalculator.io](https://zakatcalculator.io/) - Zakat calculator; supports different currencies, stocks, metals, real estates, crypto, retirement account, debt & liabilities
- [Musaffa](https://musaffa.com/) - Halal stock & ETF screener, Purification calculator
- [Zoya](https://zoya.finance) - Portfolio tracker, Halal stock screener, Zakat calculator
  - [[Web](https://zoya.finance)][[iOS](https://apps.apple.com/us/app/zoya-halal-investing-app/id1447547610)] [[Android](https://play.google.com/store/apps/details?id=com.investroo.zoya&hl=en_US)]
- [AAOIFI](https://aaoifi.com/) - Accounting and Auditing Organization for Islamic Institutions
...
- [Islamic Relief UK](https://www.islamic-relief.org.uk/) - Charity and community support

### Russia

- [HalalStarter](https://halalstarter.com) - Muslim crowdfunding

---

## 🎯 Other Useful Resources

- [MPAC - Muslim Public Affairs Council](https://www.mpac.org/) - US Advocacy and community engagement
...
- [react-hijri](https://www.npmjs.com/package/react-hijri) - React Hijri Datepicker calendar component

---

## 🤝 Contributing

Feel free to submit pull requests or issues to add more resources to this list!
